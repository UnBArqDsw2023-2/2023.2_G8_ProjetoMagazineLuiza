...
#### X.1.1 Visão Geral: Cliente-Servidor
...
<div align = "center"><img src="https://raw.githubusercontent.com/UnBArqDsw2023-2/2023.2_G8_ProjetoMagazineLuiza/main/docs/Assets/ArquiteturaReutilizacao/VisaoImplementacao/componentes_cliente_servidor.png" alt="Figura X: Diagrama de componentes da arquitetura Cliente Servidor"></div>
<p align='center'>
Figura X: Diagrama de componentes da arquitetura Cliente Servidor. Autores: Natan Santana e Guilherme Barbosa
</p>

#### X.1.2 Servidor: Arquitetura Hexagonal
...
<div align = "center"><img src="https://raw.githubusercontent.com/UnBArqDsw2023-2/2023.2_G8_ProjetoMagazineLuiza/main/docs/Assets/ArquiteturaReutilizacao/VisaoImplementacao/componentes_servidor.png" alt="Figura X: Diagrama de componentes da arquitetura hexagonal do servidor"></div>
<p align='center'>
Figura X: Diagrama de componentes da arquitetura hexagonal do servidor. Autores: Natan Santana e Guilherme Barbosa
</p>

O diagrama da Figura X a seguir possui uma visão mais detalhada que permite visualizar as relações de dependências e os subcomponentes que implementam as interfaces do padrão hexagonal.

<div align = "center"><img src="https://raw.githubusercontent.com/UnBArqDsw2023-2/2023.2_G8_ProjetoMagazineLuiza/main/docs/Assets/ArquiteturaReutilizacao/VisaoImplementacao/componentes_servidor_detalhado.png" alt="Figura X: Diagrama de componentes da arquitetura hexagonal do servidor com detalhes"></div>
<p align='center'>
Figura X: Diagrama de componentes da arquitetura hexagonal do servidor com detalhes. Autores: Natan Santana e Guilherme Barbosa
</p>
...
| :--------: | :----: | :-----------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------: | :--------: |
| 25/11/2023 |  1.0   | Adição visão de dados (MER, Modelo Relacional, Dicionário de dados, scripts físico, scripts popula e scripts apaga) | [Mauricio Machado](https://github.com/MauricioMachadoFF) |     --     |
| 27/11/2023 |  1.1   | Adição visão de implementação: visão geral e servidor | [Natan Santana](https://github.com/Neitan2001) e [Guilherme Barbosa](https://github.com/guibrbs) |     --     |
| 29/11/2023 |  1.1   | Adição da visão detalhada de implementação | [Natan Santana](https://github.com/Neitan2001) e [Guilherme Barbosa](https://github.com/guibrbs) |     --     |
