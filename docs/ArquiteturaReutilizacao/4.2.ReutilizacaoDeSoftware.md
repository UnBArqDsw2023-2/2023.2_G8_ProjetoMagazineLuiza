...
| :--------: | :----: | :-----------------------------------------------------------------------------------------------------: | :------------------------------------------------------: | :--------: |
| 27/11/2023 |  1.0   | Adição de dois casos de reutilização de software no contexto de frontend (singleton e abstract factory) | [Mauricio Machado](https://github.com/MauricioMachadoFF) |     -      |
